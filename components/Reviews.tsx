    ...
    <section id="reviews" className="py-24 px-4" style={{ background: '#0a1f0e' }}>
      <div className="max-w-6xl mx-auto">
        ...
        <div ref={headerRef} className={`text-center mb-16 reveal-parent ${headerVisible ? 'is-visible' : ''}`}>
          <span className="badge-gold mb-5 anim-right reveal-d-1">গ্রাহক রিভিউ</span>
          <h2
          ...
          <p className="text-lg anim-left reveal-d-3" style={{ color: 'rgba(255,255,255,0.42)' }}>
        ...
        >
          {stats.map((s, i) => (
            <div key={s.label} className={`anim-zoom reveal-d-${i + 1}`}>
